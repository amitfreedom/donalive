...
public class VideoEncResolutionAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        ((VideoEncResolutionViewHolder) holder).mTextResolution.setTextColor(mContext.getResources().getColor(position == mSelectedIdx ? android.R.color.white : R.color.black));
    }
