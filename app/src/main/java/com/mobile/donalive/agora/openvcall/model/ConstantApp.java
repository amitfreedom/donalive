package com.mobile.donalive.agora.openvcall.model;
...
public class ConstantApp {
    ...
    public static final int DEFAULT_VIDEO_ENC_RESOLUTION_IDX = 3; // default use 240P
    public static final int DEFAULT_VIDEO_ENC_FPS_IDX = 4; // default use 15fps
