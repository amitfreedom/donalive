...
public class SmallVideoViewAdapter extends VideoViewAdapter {
    ...
    public SmallVideoViewAdapter(Activity activity, int localUid, int exceptedUid, HashMap<Integer, SurfaceView> uids,GridVideoViewContainer mGridVideoViewContainer) {
